...
const App = () => {
  ...
  return (
    <div className='flex flex-col items-center my-12 w-full text-white'>
      ...
      > */}
      <form
        className='grid grid-cols-5 content-center w-2/3 my-4'
        onSubmit={handleSubmit}
      >
        <textarea
        ...
        <select
          className='h-12 col-span-1 block resize-none rounded-r-md p-3 outline-0 text-black shadow-md'
          value={difficulty}
        ...
        <button
          className='h-12 col-start-3 rounded-md px-4 py-2 mt-4 font-bold bg-yellow-300 shadow-md text-bg-cyan'
          type='submit'
        >
          Generate
        </button>
      ...
      <div className='flex justify-center w-full'>
        <div className='h-96 w-2/3 p-3 rounded-md bg-white text-black shadow-md'>
